...
public class VideoDanmu implements Serializable {
	...
	public String toString() {
		return "自增ID:" + (danmuId == null ? "空" : danmuId) + "," + 
				"视频ID:" + (videoId == null ? "空" : videoId) + "," + 
				"唯一ID:" + (fileId == null ? "空" : fileId) + "," + 
				"用户ID:" + (userId == null ? "空" : userId) + "," + 
				"发布时间:" + (postTime == null ? "空" : DateUtils.format(postTime, DateTimePatternEnum.YYYY_MM_DD_HH_MM_SS.getPattern())) + "," + 
				"内容:" + (text == null ? "空" : text) + "," + 
				"展示位置:" + (mode == null ? "空" : mode) + "," + 
				"颜色:" + (color == null ? "空" : color) + "," + 
